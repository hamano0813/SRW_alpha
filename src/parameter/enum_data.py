...
class EnumData:
    ...
    ROBOT = dict()
    ROBOT['移动类型'] = ['空', '陸', '海', '地']
    ROBOT['尺寸'] = {0x0: 'SS', 0x1: 'S', 0x2: 'M', 0x3: 'L', 0x4: 'LL'}
    ROBOT['换乘系'] = [
        'ガンダム系(UC)',
        'ガンダム系(W)',
        'マジンガー系',
    ...
    ROBOT['空适应'] = {0x0: '-', 0x1: 'D', 0x2: 'C', 0x3: 'B', 0x4: 'A'}
    ROBOT['陆适应'] = ROBOT['海适应'] = ROBOT['宇适应'] = ROBOT['空适应']
    ROBOT['换装组'] = {0x0: 'V2ガンダム', 0x1: 'ヒュッケバインMK-Ⅲ', 0xFF: 'ーー'}

    WEAPON = dict()
    WEAPON['分类'] = {0x0: '格闘', 0x1: '射撃'}
    WEAPON['MAP类型'] = {0x0: 'ーー', 0x1: '方向指定型', 0x2: '自機中心型', 0x3: '着弾点指定型'}
    WEAPON['属性'] = ['Ⓟ', 'Ⓑ', '切', 'ボトム射出', 'ビット', '突貫', '敵味方識別']
    WEAPON['空适应'] = {0x0: '-', 0x1: 'C', 0x2: 'B', 0x3: 'A'}
    WEAPON['陆适应'] = WEAPON['海适应'] = WEAPON['宇适应'] = WEAPON['空适应']
    ...
    PILOT['先天技能'] = ['底力', '天才', 'ガッツ', '野生化', '集中力', 'SP回復', '社長', '勇者']
    PILOT['分類'] = ['主役', 'サイボーグ', 'シンクロ', '妖精']
    PILOT['性格'] = {0x0: '弱気', 0x1: '普通', 0x2: '強気', 0x3: '超強気'}
    PILOT['空适应'] = PILOT['陆适应'] = PILOT['海适应'] = PILOT['宇适应'] = ROBOT['空适应']
    PILOT['特殊技能'] = {
        0x0: 'ニュータイプ',
        0x1: '強化人間',
        0x2: '聖戦士',
