...
class EnumData:
    SCENARIO = {
        ...
        0x01: ('スーパー系', '第1話', '[01]鋼鉄のコクピット'),
        0x02: ('スーパー系', '第2話', '[02]マジンガーZ絶体絶命'),
        0x03: ('スーパー系', '第3話', '[03]ゲッターチーム出撃せよ！'),
        0x04: ('スーパー系', '第4話', '[04]ジオン再臨'),
        0x05: ('スーパー系', '第5話', '[05]シークレット・ナンバーズ'),
        0x06: ('スーパー系', '第6話', '[06]アーガマ撃墜命令'),
        0x07: ('リアル系', '第1話', '[07]バニシング・トルーパー'),
        0x08: ('リアル系', '第2話', '[08]黒いガンダム'),
        0x09: ('リアル系', '第3話', '[09]ホワイトベース救出'),
        0x0A: ('リアル系', '第4話', '[0A]死神と呼ばれたG'),
        0x0B: ('リアル系', '第5話', '[0B]ジオンの亡霊'),
        0x0C: ('リアル系', '第6話', '[0C]対決、極東基地'),
        0x0D: ('共通', '第7話', '[0D]レッツ！コンバイン'),
        0x0E: ('共通', '第8話', '[0E]出撃！その名はジャイアント・ロボ'),
        0x0F: ('スーパー系', '第9話', '[0F]風を呼ぶ者'),
        0x10: ('リアル系', '第9話', '[10]未知なる災い'),
        0x11: ('ジャブロー', '第10話', '[11]アムロ再び'),
        0x12: ('ジャブロー', '第11話', '[12]白いモビルスーツ'),
        0x13: ('ジャブロー', '第12話', '[13]戦いは誰のために'),
        0x14: ('ジャブロー', '第13話', '[14]翼を持ったガンダム'),
        0x15: ('南アタリア島', '第10話', '[15]目覚めよ、勇者'),
        0x16: ('南アタリア島', '第11話', '[16]ガンダム強奪'),
        0x17: ('南アタリア島', '第12話', '[17]野望の男'),
        0x18: ('南アタリア島', '第13話', '[18]少女が見た流星'),
        0x19: ('共通', '第14話', '[19]父との約束'),
        0x1A: ('共通', '第15話', '[1A]使徒、襲来'),
        0x1B: ('共通', '第16話', '[1B]咆哮、EVA初号機'),
        0x1C: ('共通', '第17話', '[1C]GR対GR2'),
        0x1D: ('リアル系', '第18話', '[1D]ゼータの鼓動'),
        0x1E: ('リアル系', '第19話', '[1E]第二次直上会議'),
        0x1F: ('スーパー系', '第18話', '[1F]紅い稲妻 空飛ぶマジンガー'),
        0x20: ('スーパー系', '第19話', '[20]激突！ゲッターロボVSゲッターロボG'),
        0x21: ('共通', '第20話0', '[21]決戦、第2新東京市'),
        0x22: ('共通', '第20話', '[22]決戦、第2新東京市'),
        0x23: ('EVA弐号機', '第21話0', '[23]聖戦士たち'),
        0x24: ('EVA弐号機', '第21話', '[24]聖戦士たち'),
        0x25: ('EVA弐号機', '第22話', '[25]エレの霊力'),
        0x26: ('EVA弐号機', '第23話', '[24]ナの国の女王'),
        0x27: ('EVA弐号機', '第24話', '[25]オーラロード'),
        0x28: ('EVA弐号機', '第25話', '[26]東京上空'),
        0x29: ('極東基地', '第21話', '[27]獣を超え、人を超え、いでよ神の戦士'),
        0x2A: ('極東基地', '第22話', '[28]戦いの海へ'),
        0x2B: ('極東基地', '第23話1', '[29]マジンガーZ対暗黒大将軍'),
        0x2C: ('極東基地', '第23話2', '[29]マジンガーZ対暗黒大将軍'),
        0x2D: ('極東基地', '第24話', '[2A]ボルテス起死回生'),
        0x2E: ('極東基地', '第25話', '[2B]シャーキン悪魔の戦い'),
        0x2F: ('宇宙', '第21話', '[2C]ホンコン・シティ'),
        0x30: ('宇宙', '第22話', '[2D]ガンダム、星の海へ'),
        0x31: ('宇宙', '第23話', '[2E]始動ダブルゼータ'),
        0x32: ('宇宙', '第24話', '[2F]ソロモンの悪夢'),
        0x33: ('宇宙', '第25話', '[30]クロスボーン・バンガード'),
        0x34: ('EVA弐号機/極東基地', '第26話', '[31]紅いエヴァンゲリオン'),
        0x35: ('宇宙', '第26話', '[32]海からのマレビト'),
        0x36: ('共通', '第27話', '[33]マシン展開'),
        0x37: ('EVA2体同時攻撃', '第30話', '[34]瞬間、心重ねて'),
        0x38: ('弾丸を撃ち落す', '第31話', '[35]ブービー・トラップ'),
        0x39: ('弾丸を撃ち落す', '第32話', '[36]カウント・ダウン'),
        0x3A: ('弾丸を撃ち落す', '第33話', '[37]トランス・フォーメーション'),
        0x3B: ('弾丸を撃ち落す', '第34話', '[38]隠された殺意'),
        0x3C: ('弾丸を撃ち落す', '第35話', '[39]サタン・ファイト'),
        0x3D: ('弾丸を撃ち落す', '第36話', '[3A]リン・ミンメイ'),
        0x3E: ('弾丸を撃ち落す', '第37話', '[3B]ジュピトリアン'),
        0x3F: ('弾丸を撃ち落す', '第38話', '[3C]帝国の女王'),
        0x40: ('弾丸を撃ち落す', '第39話', '[3D]終末への前奏曲'),
        0x41: ('EVAで受け止める', '第31話', '[3E]奇跡の価値は'),
        0x42: ('EVAで受け止める', '第32話', '[3F]スペース・フォールド'),
        0x43: ('EVAで受け止める', '第33話', '[40]アームド・アタック'),
        0x44: ('EVAで受け止める', '第34話', '[41]天敵との遭遇'),
        0x45: ('EVAで受け止める', '第35話', '[42]イングラムの真意'),
        0x46: ('EVAで受け止める', '第36話', '[43]ミス・マクロス'),
        0x47: ('EVAで受け止める', '第37話', '[44]木星からの逃亡者'),
        0x48: ('EVAで受け止める', '第38話', '[45]人類を導く者'),
        0x49: ('EVAで受け止める', '第39話', '[46]ファースト・コンタクト'),
        0x4A: ('共通', '第40話', '[47]ビッグ・エスケープ'),
        0x4B: ('共通', '第41話', '[48]バイバイ・マルス'),
        0x4C: ('リーンホースJr.隊', '第42話', '[49]アクシズからの使者'),
        0x4D: ('リーンホースJr.隊', '第43話', '[4A]プルとアクシズと'),
        0x4E: ('リーンホースJr.隊', '第44話', '[4B]リィナの血'),
        0x4F: ('リーンホースJr.隊', '第45話', '[4C]漆黒の天使来たりて'),
        0x50: ('グラン・ガラン隊', '第42話', '[4D]ジュピター・ゴースト'),
        0x51: ('グラン・ガラン隊', '第43話', '[4E]宇宙に咲く妖花'),
        0x52: ('グラン・ガラン隊', '第44話', '[4F]ゼロと呼ばれたガンダム'),
        0x53: ('グラン・ガラン隊', '第45話', '[50]強襲、阻止限界点'),
        0x54: ('ゴラオン隊', '第42話', '[51]父よ地球は近い'),
        0x55: ('ゴラオン隊', '第43話', '[52]静止した闇の中で'),
        0x56: ('ゴラオン隊', '第44話', '[53]赤い髪の女'),
        0x57: ('ゴラオン隊', '第45話', '[54]神か、悪魔か・・・'),
        0x58: ('スーパー系', '第46話', '[55]龍と虎'),
        0x59: ('リアル系', '第46話', '[56]第三の力'),
        0x5A: ('共通', '第47話', '[57]男の戦い'),
        0x5B: ('共通', '第50話', '[58]ヴァリアブル・フォーメーション'),
        0x5C: ('グラン・ガラン隊', '第51話', '[59]ガラスの王国'),
        0x5D: ('ラー・カイラム隊', '第51話', '[5A]ダカールの日'),
        0x5E: ('グラン・ガラン隊', '第52話', '[5B]王国崩壊'),
        0x5F: ('ラー・カイラム隊', '第52話', '[5C]バイブレーション'),
        0x60: ('ゴラオン隊', '第54話', '[5D]思い出を未来へ'),
        0x61: ('ラー・カイラム隊', '第53話', '[5E]ソロモン攻略戦'),
        0x62: ('ラー・カイラム隊', '第54話', '[5F]女たちの戦場'),
        0x63: ('ラー・カイラム隊', '第55話', '[60]駆け抜ける嵐'),
        0x64: ('ゴラオン隊', '第51話', '[61]あしゅら男爵、散る'),
        0x65: ('ゴラオン隊', '第52話', '[62]魔神皇帝'),
        0x66: ('グラン・ガラン隊', '第53話', '[63]クロス・ファイト'),
        0x67: ('グラン・ガラン隊', '第54話', '[64]異邦人たちの帰還'),
        0x68: ('ゴラオン隊', '第53話', '[65]地球を賭けた一騎討ち'),
        0x69: ('共通', '第56話', '[66]ジオンの幻像'),
        0x6A: ('ゴラオン隊', '第55話', '[67]父の胸の中で泣け！'),
        0x6B: ('グラン・ガラン隊', '第55話', '[68]女王リリーナ'),
        0x6C: ('共通', '第57話0', '[69]天使の輪の上で'),
        0x6D: ('共通', '第57話', '[69]天使の輪の上で'),
        0x6E: ('アクシズ', '第58話', '[6A]神の国への誘惑'),
        0x6F: ('アクシズ', '第59話', '[6B]クロス・ターゲット'),
        0x70: ('アクシズ', '第60話', '[6C]戦士、再び・・・'),
        0x71: ('エンジェル・ハイロゥ', '第58話', '[6D]勝者と敗者に祝福を'),
        0x72: ('エンジェル・ハイロゥ', '第59話', '[6E]せめて、人間らしく'),
        0x73: ('エンジェル・ハイロゥ', '第60話', '[6F]最後のシ者'),
        0x74: ('共通', '第61話', '[70]運命の矢'),
        0x75: ('共通', '第62話1', '[71]愛・おぼえていますか'),
        0x76: ('共通', '第62話2', '[71]愛・おぼえていますか'),
        0x77: ('共通', '第64話1', '[72]Air'),
        0x78: ('共通', '第64話2', '[72]Air'),
        0x79: ('共通', '第65話', '[73]ギア・オブ・デスティニー'),
        0x7A: ('熟練度45以上', '第66話', '[74]絶望の宴は今から始まる'),
        0x7B: ('熟練度45以上', '第67話1', '[75]この星の明日のために'),
        0x7C: ('熟練度45以上', '第67話2', '[75]この星の明日のために'),
        0x7D: ('熟練度45以上', '第67話3', '[75]この星の明日のために'),
        0x7E: ('ダミー', 'ダミー', 'ダミー'),
        0x7F: ('熟練度45未満', '第66話', '[77]人類に逃げ場なし'),
        0x80: ('熟練度45未満', '第67話1', '[78]鋼の魂'),
        0x81: ('熟練度45未満', '第67話2', '[78]鋼の魂'),
        0x82: ('ダミー', 'ダミー', 'ダミー'),
        0x83: ('ダミー', 'ダミー', 'ダミー'),
        0x84: ('ダミー', 'ダミー', 'ダミー'),
        0x85: ('ダミー', 'ダミー', 'ダミー'),
        0x86: ('共通', '第28話', '[7C]ＥＯＴの島'),
        0x87: ('スーパー系', '第29話', '[7D]心に念じる見えない刃'),
        0x88: ('リアル系', '第29話', '[7E]黒い超闘士'),
        0x89: ('共通', '第48話', '[7F]誰がために鐘は鳴る'),
        0x8A: ('共通', '第49話', '[80]進路に光明、退路に絶望'),
        0x8B: ('力ずくで撃退', '第30話', '[81]精霊憑依'),
    }
    STAGE = {
        0x00: '共通 プロローグ プロローグ',
