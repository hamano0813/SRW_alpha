...
class EnumData:
    ...
    COMMAND = dict()
    COMMAND['比较'] = {0x0: '>', 0x1: '≥', 0x2: '=', 0x3: '≤', 0x4: '<'}
    COMMAND['触发'] = {0x0: '未触发', 0x1: '已触发'}
    COMMAND['阵营'] = {0x0: '中立', 0x1: '本方', 0x2: '友军', 0x3: '敌方'}
    COMMAND['点数'] = {0x0: '熟练度', 0x1: '恋爱度', 0x2: '宿敌度', 0x3: '未知', 0x5: '明美点', 0x6: '未沙点'}
    COMMAND['菜单'] = ['移動', '攻撃', '精神', '変形', '分離', '合体', '説得', '地上', '水中', '空中', '地中', '水上',
                     'パーツ', '修理', '補給', '接続', '切断', '待機', '搭載', '発進', '能力']
    COMMAND['演出'] = ['会心', '护盾', '破盾'],
