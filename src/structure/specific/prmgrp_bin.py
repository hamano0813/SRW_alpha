...
UPGRADE_STRUCTURE = {
    ...
    '改造タイプ[A]': Sequence({'費用': Value(0x0, 0x2), '上昇値': Value(0x2, 0x2)}, 0xC8, 0x4, 0xA),
    '改造タイプ[B]': Sequence({'費用': Value(0x0, 0x2), '上昇値': Value(0x2, 0x2)}, 0xF0, 0x4, 0xA),
    '改造タイプ[C]': Sequence({'費用': Value(0x0, 0x2), '上昇値': Value(0x2, 0x2)}, 0x118, 0x4, 0xA),
    '改造タイプ[D]': Sequence({'費用': Value(0x0, 0x2), '上昇値': Value(0x2, 0x2)}, 0x140, 0x4, 0xA),
}
