...
UPGRADE_STRUCTURE = {
    'HP改造': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x0, 0x4, 0xA),
    'EN改造': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x28, 0x4, 0xA),
    '运动性改造': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x50, 0x4, 0xA),
    '装甲改造': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x78, 0x4, 0xA),
    '限界改造': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0xA0, 0x4, 0xA),
    '武器类型1': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0xC8, 0x4, 0xA),
    '武器类型2': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0xF0, 0x4, 0xA),
    '武器类型3': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x118, 0x4, 0xA),
    '武器类型4': Sequence({'费用': Value(0x0, 0x2), '幅度': Value(0x2, 0x2)}, 0x140, 0x4, 0xA),
}
...
class PrmgrpBIN(Rom):
    def __init__(self):
        ...
        self.structures = {
            ...
            'A型血主角列表': Sequence(BLOOD_STRUCTURE, 0x26188, 0x40, 0xC),
            'B型血主角列表': Sequence(BLOOD_STRUCTURE, 0x26198, 0x40, 0xC),
            'AB型血主角列表': Sequence(BLOOD_STRUCTURE, 0x261A8, 0x40, 0xC),
            'O型血主角列表': Sequence(BLOOD_STRUCTURE, 0x261B8, 0x40, 0xC),
            ...
            '机体改造列表': Sequence(UPGRADE_STRUCTURE, 0x26494, 0x168, 0x1)
        }
