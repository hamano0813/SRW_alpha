...
class CommandExplain:
    def __init__(self, **kwargs):
        ...
        self.COMMAND_SETTING = {
            ...
            0xB6: ('{0}HP少于{1}%', [self.w['机师'], ParamVSpin('HP', 0)],
                   '条件判断 - 判断机师HP量',
                   '判断机师HP量',
                   ),
            0xB7: ('{0}被击破',
    ...
    def explain(self, command: dict[str, int | list[int] | str]):
        ...
        param_setting: tuple[str, list[ParamWidget], str, str] = self.COMMAND_SETTING.get(code, (str(code), tuple()))
